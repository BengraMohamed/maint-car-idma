...
import "./consm.css"
 function ConsmList() {
    ...
    const fetchConsm = async () => {
        await axios.get(`http://localhost:8000/api/consommations`).then(({ data }) => {
            setConsm(data);
        })
    }
    ...
    const delConsm = async (id) => {
        ...
        await axios.delete(`http://localhost:8000/api/consommations/${id}`).then(({ data }) => {
            Swal.fire({
                icon: 'success',
                text: data.message
            })
...
return (
    <div className='container'><br /> <br />
            ...
            <div className="single__card-csm ">
              <h4  >Espace Consomamtion </h4>
    ...
    <div className="col-12" >
        ...
        <tr key={key}>
            ...
            <td>{row.montant}</td>
            <td> 
                <img width="78px" height="50px" src={`http://localhost:8000/storage/consommations/image/${row.image}`}   /> 
            </td>
            <td>
