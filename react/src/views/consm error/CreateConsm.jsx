          ...
          <h2 className="title_Consm"  >Nouvelle Consommation :   </h2><br /> <br />
            ...
            <Row>
              ...
              <Form.Group controlId="nom" style={{marginTop:"-60px"}}>
                    <Form.Label className="g_style"  >Date :</Form.Label>
                    <Form.Control className='w-75 form-control' type="date" value={date} onChange={(event) => {
                ...
                <Form.Group controlId="marque">
                  ...
                  <Form.Label className="g_style">Quantite :</Form.Label>
                     <Form.Control className='w-75 form-control' type="text" value={qte} onChange={(event) => {
                ...
                <Form.Group controlId="marque">
                    <br />
                  <Form.Label className="g_style">Montant :</Form.Label>
