...
function EditConsm() {
    ...
    const fetchConsm = async () => {
        await axios.get(`http://localhost:8000/api/consm/${id}`).then(({ data }) => {
    ...
    const updateConsm = async (e) => {
        ...
        await axios.post(`http://localhost:8000/api/consm/${id}`, formData).then(({ data }) => {
            Swal.fire({
                icon: "success",
                text: data.message
            })
          ...
          <br />
            ...
            <br /> <br /><br />
              ...
              <Form.Group controlId="nom" style={{marginTop:"-60px"}}>
                ...
                <Col>
              <Form.Group controlId="nom" style={{marginTop:"-60px"}}>
                    <Form.Label className="g_style_edit_Maint"  >Quantité : :</Form.Label>
              ...
              <Form.Group controlId="nom" style={{marginTop:"-60px" ,marginLeft:"110px"}}>
                    <Form.Label className="g_style_edit_Maint"  >Montant payé:</Form.Label>
                    <Form.Control className='w-100  form-control' type="number"  value={montant} onChange={(event) => {
